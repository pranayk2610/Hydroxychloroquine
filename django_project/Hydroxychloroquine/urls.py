...
urlpatterns = [
    ...
    path("passwordReset/done/",views.passwordResetdone,name="password_reset_done",),
    path("passwordResetConfirm/<uidb64>/<token>/",views.passwordResetConfirm,name="password_reset_confirm",),
    path("passwordResetComplete/",views.passwordResetComplete,name="password_reset_complete",),
]
